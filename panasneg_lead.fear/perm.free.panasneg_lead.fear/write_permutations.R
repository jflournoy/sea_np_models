...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panasneg_lead.fear/panasneg_lead.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panasneg_lead.fear//perm.free.panasneg_lead.fear', 'permute_free.RDS')
