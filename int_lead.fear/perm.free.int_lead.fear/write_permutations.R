...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//int_lead.fear/int_lead.fear/debug.Rdata')
attach(designmat)
...
v <- 1 #to get example brain data
  ...
  model_data <- na.omit(data.frame(
    internalizing_lead = internalizing_lead, 
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//int_lead.fear//perm.free.int_lead.fear', 'permute_free.RDS')
