cmdargs <- c("-m","/net/holynfs01/srv/export/mclaughlin/share_root/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint/gad.fear/mask.nii.gz",
...
"--model","/net/holynfs01/srv/export/mclaughlin/share_root/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint/gad.fear/model.R",
"--output","gad.fear/gad.fear.",
debug.Rdata
"--slurmN", "60"
)
