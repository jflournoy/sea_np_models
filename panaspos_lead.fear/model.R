...
processVoxel <- function(v) {
  ...
  if (!(is.null(panaspos_lead.fear))) {
    ...
    std_coefs <- coef(beta(panaspos_lead.fear))
  ...
  if(!(is.null(panaspos_lead.fear_sw))){
    coefs_sw <- panaspos_lead.fear_sw
