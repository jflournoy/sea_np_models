...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//socanx.happy//perm.free.socanx.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = LSA_ANX ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
