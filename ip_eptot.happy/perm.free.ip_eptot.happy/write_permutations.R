...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_eptot.happy/ip_eptot.happy/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_eptot.happy//perm.free.ip_eptot.happy', 'permute_free.RDS')
