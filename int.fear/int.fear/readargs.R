cmdargs <- c("-m","/net/holynfs01/srv/export/mclaughlin/share_root/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint/int.fear/mask.nii.gz",
...
"--model","/net/holynfs01/srv/export/mclaughlin/share_root/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint/int.fear/model.R",
"--output","int.fear/int.fear.",
debug.Rdata
"--slurmN", "60"
)
