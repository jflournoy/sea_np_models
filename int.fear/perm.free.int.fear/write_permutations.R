...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//int.fear/int.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//int.fear//perm.free.int.fear', 'permute_free.RDS')
