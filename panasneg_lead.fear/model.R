...
processVoxel <- function(v) {
  ...
  if (!(is.null(panasneg_lead.fear))) {
    ...
    std_coefs <- coef(beta(panasneg_lead.fear))
  ...
  if(!(is.null(panasneg_lead.fear_sw))){
    coefs_sw <- panasneg_lead.fear_sw
