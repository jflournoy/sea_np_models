...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//gad_lead.fear//perm.free.bw.gad_lead.fear/permute_free.RDS'
  targetDV = 'GCEN_BRAIN'
  formula = GAD7_TOT_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
