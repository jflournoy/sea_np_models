...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_chsev.fear/ip_chsev.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_chsev.fear//perm.free.ip_chsev.fear', 'permute_free.RDS')
