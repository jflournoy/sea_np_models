...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_eptot.fear/ip_eptot.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_eptot.fear//perm.free.ip_eptot.fear', 'permute_free.RDS')
