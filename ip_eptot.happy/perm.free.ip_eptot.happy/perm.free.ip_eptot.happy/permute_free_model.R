...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_eptot.happy//perm.free.ip_eptot.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = IP_EPISODICTOT ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
