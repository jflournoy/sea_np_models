...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//socanx_lead.happy/socanx_lead.happy/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//socanx_lead.happy//perm.free.socanx_lead.happy', 'permute_free.RDS')
