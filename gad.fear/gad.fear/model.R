...
processVoxel <- function(v) {
  ...
  e_sandwich <- try(gad.fear_sw <- clubSandwich::coef_test(e, vcov = "CR2"))
  ...
  if(!(is.null(gad.fear_sw))){
    coefs_sw <- gad.fear_sw
