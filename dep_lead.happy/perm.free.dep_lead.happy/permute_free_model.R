...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//dep_lead.happy//perm.free.dep_lead.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = PHQ9_TOT_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
