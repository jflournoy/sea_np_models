...
processVoxel <- function(v) {
  ...
  e_sandwich <- try(int.fear_sw <- clubSandwich::coef_test(e, vcov = "CR2"))
  ...
  if(!(is.null(int.fear_sw))){
    coefs_sw <- int.fear_sw
