...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panasneg_lead.happy//perm.free.panasneg_lead.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = PANASNEG_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
