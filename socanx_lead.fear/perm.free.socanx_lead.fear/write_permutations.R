...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//socanx_lead.fear/socanx_lead.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//socanx_lead.fear//perm.free.socanx_lead.fear', 'permute_free.RDS')
