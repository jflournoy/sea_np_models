...
while IFS=  read -r -d $'\0'; do
    file_list+=("$REPLY")
done < <(find /net/holynfs01/srv/export/mclaughlin/share_root/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint -regex '.*/\(stresscomp\)\.\(fear\|happy\).*/cs/cs\.\(dep\|gad\|socanx\|betweenwithin2\)\.\(timecenterXwcen\|wcen\|gcen\|timecenterXgcen\)_\(brain\|chronicsev\)\.tvalue.nii.gz' -print0)

#done < <(find /net/holynfs01/srv/export/mclaughlin/share_root/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint -regex '.*/\(gad\|dep\|socanx\|stresscomp\)\.\(fear\|happy\).*/cs/cs\.\(dep\|gad\|socanx\|betweenwithin2\)\.\(timecenterXwcen\|wcen\|gcen\|timecenterXgcen\)_\(brain\|chronicsev\)\.tvalue.nii.gz' -print0)
