...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//int.fear//perm.free.int.fear/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = internalizing ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
