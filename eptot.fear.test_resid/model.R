# ##
# load('eptot.fear.old/debug.Rdata')
# attach(designmat)
# v <- 1e5
# ##
...
processVoxel <- function(v) {
  ...
  model_formula <- BRAIN ~ 1 + TIMECENTER + GCEN_EPISODICTOT + WCEN_EPISODICTOT
