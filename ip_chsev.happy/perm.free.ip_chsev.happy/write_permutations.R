...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_chsev.happy/ip_chsev.happy/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_chsev.happy//perm.free.ip_chsev.happy', 'permute_free.RDS')
