...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//socanx_lead.happy//perm.free.socanx_lead.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = LSA_ANX_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
