...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//gad_lead.fear/gad_lead.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//gad_lead.fear//perm.free.bw.gad_lead.fear', 'permute_free.RDS')
