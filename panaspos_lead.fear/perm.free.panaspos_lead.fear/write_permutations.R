...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panaspos_lead.fear/panaspos_lead.fear/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panaspos_lead.fear//perm.free.panaspos_lead.fear', 'permute_free.RDS')
