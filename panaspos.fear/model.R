...
processVoxel <- function(v) {
  ...
  e_sandwich <- try(panaspos.fear_sw <- clubSandwich::coef_test(e, vcov = "CR2"))
  ...
  if (!(is.null(panaspos.fear))) {
    ...
    std_coefs <- coef(beta(panaspos.fear))
  ...
  if(!(is.null(panaspos.fear_sw))){
    coefs_sw <- panaspos.fear_sw
