...
processVoxel <- function(v) {
  ...
  e_sandwich <- try(gad_lead.fear_sw <- clubSandwich::coef_test(e, vcov = "CR2"))
  ...
  if (!(is.null(gad_lead.fear))) {
    ...
    std_coefs <- coef(beta(gad_lead.fear))
  ...
  if(!(is.null(gad_lead.fear_sw))){
    coefs_sw <- gad_lead.fear_sw
