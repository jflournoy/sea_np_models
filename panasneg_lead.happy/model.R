...
processVoxel <- function(v) {
  ...
  model_formula <- PANASNEG_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
  ...
  e <- try(panasneg_lead.happy <-
              nlme::lme(PANASNEG_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN,
  ...
  if (!(is.null(panasneg_lead.happy))) {
    ...
    std_coefs <- coef(beta(panasneg_lead.happy))
  ...
  if(!(is.null(panasneg_lead.happy_sw))){
    coefs_sw <- panasneg_lead.happy_sw
