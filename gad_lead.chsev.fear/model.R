...
processVoxel <- function(v) {
  ...
  model_formula <- GAD7_TOT_lead ~ 1 + TIMECENTER + WCEN_CHRONICSEV + GCEN_CHRONICSEV + GCEN_BRAIN + WCEN_BRAIN
  ...
  e <- try(gad_lead.chsev.fear <-
              nlme::lme(GAD7_TOT_lead ~ 1 + TIMECENTER + WCEN_CHRONICSEV + GCEN_CHRONICSEV + GCEN_BRAIN + WCEN_BRAIN,
  ...
  if (!(is.null(gad_lead.chsev.fear))) {
    ...
    std_coefs <- coef(beta(gad_lead.chsev.fear))
  ...
  if(!(is.null(gad_lead.chsev.fear_sw))){
    coefs_sw <- gad_lead.chsev.fear_sw
