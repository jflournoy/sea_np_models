...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panaspos_lead.happy//perm.free.panaspos_lead.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = PANASPOS_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
