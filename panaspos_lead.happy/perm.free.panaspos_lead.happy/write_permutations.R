...
load('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panaspos_lead.happy/panaspos_lead.happy/debug.Rdata')
attach(designmat)
...
permpath <- file.path('/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//panaspos_lead.happy//perm.free.panaspos_lead.happy', 'permute_free.RDS')
