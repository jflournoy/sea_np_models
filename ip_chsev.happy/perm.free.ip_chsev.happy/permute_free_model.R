...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//ip_chsev.happy//perm.free.ip_chsev.happy/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = IP_CHRONICSEV ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
