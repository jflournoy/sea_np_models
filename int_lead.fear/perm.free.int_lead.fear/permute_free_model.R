...
processVoxel <- function(v) {
  ...
  permutationRDS = '/mnt/stressdevlab/stress_pipeline/Group/FaceReactivity/NewNeuropoint//int_lead.fear//perm.free.int_lead.fear/permute_free.RDS'
  targetDV = 'WCEN_BRAIN'
  formula = internalizing_lead ~ 1 + TIMECENTER + GCEN_BRAIN + WCEN_BRAIN
