...
processVoxel <- function(v) {
  ...
  if (!(is.null(socanx_lead.fear))) {
    ...
    std_coefs <- coef(beta(socanx_lead.fear))
  ...
  if(!(is.null(socanx_lead.fear_sw))){
    coefs_sw <- socanx_lead.fear_sw
